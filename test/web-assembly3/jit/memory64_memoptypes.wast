...
(assert_trap (invoke "i64.atomic.rmw.cmpxchg_2" (i64.const 0x100000000) (i64.const 0) (i64.const 0)) "out of bounds memory access")
(assert_trap (invoke "i64.atomic.rmw8.cmpxchg_2" (i64.const 0x100000000) (i64.const 0) (i64.const 0)) "out of bounds memory access")
(assert_trap (invoke "i64.atomic.rmw16.cmpxchg_2" (i64.const 0x100000000) (i64.const 0) (i64.const 0)) "out of bounds memory access")
(assert_trap (invoke "i64.atomic.rmw32.cmpxchg_2" (i64.const 0x100000000) (i64.const 0) (i64.const 0)) "out of bounds memory access")
