(module
  ...
  (func (export "ref_eq1") (result i32 i32 i32)
    (ref.test (ref eq) (table.get $t_any (i32.const 0)))
    (ref.test (ref eq) (table.get $t_struct (i32.const 0)))
    (ref.test (ref eq) (table.get $t_array (i32.const 0)))
    (ref.cast (ref eq) (table.get $t_any (i32.const 1))) (drop)
    (ref.cast (ref eq) (table.get $t_struct (i32.const 1))) (drop)
    (ref.cast (ref eq) (table.get $t_array (i32.const 1))) (drop)
  )

  (func (export "ref_eq2") (result i32 i32 i32 i32 i32)
    (ref.test (ref eq) (table.get $tn_any (i32.const 0)))
    (ref.test (ref eq) (table.get $tn_any (i32.const 1)))
    (ref.test (ref eq) (table.get $tn_any (i32.const 2)))
    (ref.test (ref eq) (table.get $tn_struct (i32.const 0)))
    (ref.test (ref eq) (table.get $tn_array (i32.const 1)))
    (ref.cast (ref eq) (table.get $tn_any (i32.const 1))) (drop)
    (ref.cast (ref eq) (table.get $tn_any (i32.const 2))) (drop)
    (ref.cast (ref eq) (table.get $tn_struct (i32.const 1))) (drop)
    (ref.cast (ref eq) (table.get $tn_array (i32.const 1))) (drop)
  )

  (func (export "ref_eq3")
    (ref.cast (ref eq) (table.get $tn_any (i32.const 0))) (drop)
  )

  (func (export "ref_eq4")
    (ref.cast (ref eq) (table.get $tn_array (i32.const 0))) (drop)
  )

  (func (export "ref_eq5") (result i32 i32 i32 i32 i32)
    (ref.test (ref null eq) (table.get $tn_any (i32.const 0)))
    (ref.test (ref null eq) (table.get $tn_any (i32.const 1)))
    (ref.test (ref null eq) (table.get $tn_any (i32.const 2)))
    (ref.test (ref null eq) (table.get $tn_struct (i32.const 1)))
    (ref.test (ref null eq) (table.get $tn_array (i32.const 0)))
    (ref.cast (ref null eq) (table.get $tn_any (i32.const 0))) (drop)
    (ref.cast (ref null eq) (table.get $tn_any (i32.const 1))) (drop)
    (ref.cast (ref null eq) (table.get $tn_any (i32.const 2))) (drop)
    (ref.cast (ref null eq) (table.get $tn_struct (i32.const 0))) (drop)
    (ref.cast (ref null eq) (table.get $tn_struct (i32.const 1))) (drop)
    (ref.cast (ref null eq) (table.get $tn_array (i32.const 0))) (drop)
    (ref.cast (ref null eq) (table.get $tn_array (i32.const 1))) (drop)
  )

  (func (export "ref_eq6") (result i32 i32 i32 i32 i32 i32)
     (block (result i32)
        (block (result anyref) (br_on_cast 0 anyref (ref eq) (table.get $tn_any (i32.const 0))) (i32.const 6) (br 1))
        (drop) (i32.const 12))
     (block (result i32)
        (block (result anyref) (br_on_cast_fail 0 anyref (ref eq) (table.get $tn_any (i32.const 1))) (i32.const 7) (br 1))
        (drop) (i32.const 13))
     (block (result i32)
        (block (result anyref) (br_on_cast 0 anyref (ref eq) (table.get $tn_any (i32.const 2))) (i32.const 8) (br 1))
        (drop) (i32.const 14))
     (block (result i32)
        (block (result anyref) (br_on_cast_fail 0 anyref (ref eq) (table.get $tn_struct (i32.const 0))) (i32.const 9) (br 1))
        (drop) (i32.const 15))
     (block (result i32)
        (block (result anyref) (br_on_cast 0 anyref (ref eq) (table.get $tn_array (i32.const 0))) (i32.const 10) (br 1))
        (drop) (i32.const 16))
     (block (result i32)
        (block (result anyref) (br_on_cast_fail 0 anyref (ref eq) (table.get $tn_array (i32.const 1))) (i32.const 11) (br 1))
        (drop) (i32.const 17))
  )

  (func (export "ref_eq7") (result i32 i32 i32 i32 i32 i32)
     (block (result i32)
        (block (result anyref) (br_on_cast 0 anyref (ref null eq) (table.get $tn_any (i32.const 0))) (i32.const 2) (br 1))
        (drop) (i32.const 8))
     (block (result i32)
        (block (result anyref) (br_on_cast_fail 0 anyref (ref null eq) (table.get $tn_any (i32.const 1))) (i32.const 3) (br 1))
        (drop) (i32.const 9))
     (block (result i32)
        (block (result anyref) (br_on_cast 0 anyref (ref null eq) (table.get $tn_any (i32.const 2))) (i32.const 4) (br 1))
        (drop) (i32.const 10))
     (block (result i32)
        (block (result anyref) (br_on_cast_fail 0 anyref (ref null eq) (table.get $tn_struct (i32.const 0))) (i32.const 5) (br 1))
        (drop) (i32.const 11))
     (block (result i32)
        (block (result anyref) (br_on_cast 0 anyref (ref null eq) (table.get $tn_array (i32.const 0))) (i32.const 6) (br 1))
        (drop) (i32.const 12))
     (block (result i32)
        (block (result anyref) (br_on_cast_fail 0 anyref (ref null eq) (table.get $tn_array (i32.const 1))) (i32.const 7) (br 1))
        (drop) (i32.const 13))
  )

  (func (export "ref_eq8") (result i32 i32 i32 i32)
     (block (result i32)
        (block (result anyref) (br_on_cast 0 anyref (ref eq) (table.get $t_any (i32.const 0))) (i32.const 9) (br 1))
        (drop) (i32.const 13))
     (block (result i32)
        (block (result anyref) (br_on_cast_fail 0 anyref (ref null eq) (table.get $t_any (i32.const 1))) (i32.const 10) (br 1))
        (drop) (i32.const 14))
     (block (result i32)
        (block (result anyref) (br_on_cast 0 anyref (ref eq) (table.get $t_struct (i32.const 1))) (i32.const 11) (br 1))
        (drop) (i32.const 15))
     (block (result i32)
        (block (result anyref) (br_on_cast_fail 0 anyref (ref null eq) (table.get $t_array (i32.const 0))) (i32.const 12) (br 1))
        (drop) (i32.const 16))
  )
)
...
(assert_return (invoke "ref_eq1") (i32.const 1) (i32.const 1) (i32.const 1))
(assert_return (invoke "ref_eq2") (i32.const 0) (i32.const 1) (i32.const 1) (i32.const 0) (i32.const 1))
(assert_trap (invoke "ref_eq3") "cast failure")
(assert_trap (invoke "ref_eq4") "cast failure")
(assert_return (invoke "ref_eq5") (i32.const 1) (i32.const 1) (i32.const 1) (i32.const 1) (i32.const 1))
(assert_return (invoke "ref_eq6") (i32.const 6) (i32.const 7) (i32.const 14) (i32.const 15) (i32.const 10) (i32.const 11))
(assert_return (invoke "ref_eq7") (i32.const 8) (i32.const 3) (i32.const 10) (i32.const 5) (i32.const 12) (i32.const 7))
(assert_return (invoke "ref_eq8") (i32.const 13) (i32.const 10) (i32.const 15) (i32.const 12))
