...
(func (export "test15") (result f32) (local f32 f32)
    f32.const 3.3
    local.set 0
    f32.const 4.4
    local.set 1
...
(func (export "test16") (result i32) (local f32 f32)
    f32.const 3.3
    local.set 0
    f32.const 4.4
    local.set 1
...
(func (export "test17") (result i32 i32 i32 i32)
    f32.const -0x0p+0
    f32.const -nan
    f32.ne
...
(assert_return (invoke "test15") (f32.const 6.6))
(assert_return (invoke "test16") (i32.const 6))
(assert_return (invoke "test17") (i32.const 1) (i32.const 1) (i32.const 0) (i32.const 1))
