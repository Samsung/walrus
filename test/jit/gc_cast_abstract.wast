(module
  ...
  (func (export "ref_any4") (result i32 i32 i32)
  ...
  (func (export "ref_any5") (result i32 i32 i32 i32)
     (block (result i32)
...
(assert_trap (invoke "tn_array3") "cast failure")
(assert_return (invoke "ref_any4") (i32.const 1) (i32.const 1) (i32.const 1))
(assert_return (invoke "ref_any5") (i32.const 6) (i32.const 11) (i32.const 12) (i32.const 9))
(assert_return (invoke "ref_any6") (i32.const 15) (i32.const 12) (i32.const 17) (i32.const 14))
