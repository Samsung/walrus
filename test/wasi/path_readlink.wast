(module
  ...
  (export "read_from_symlink" (func $read_from_symlink))
  (export "read_from_file" (func $read_from_file))
  (data (i32.const 300) "./symlink.txt")

  (func $read_from_symlink
	  ...
	  i32.const 100 ;; Where to store read content in memory
	  i32.const 100 ;; Maximum amount of bytes to store
	  i32.const 0 ;; Lenghth of read amount
      call $path_readlink
	  drop
  ...
  (func $read_from_file
    ...
    i32.const 0 ;; Length of file name
	i32.load
...
(assert_return (invoke "read_from_symlink"))
