...
IF (${WALRUS_OUTPUT} MATCHES "shell")
    ADD_EXECUTABLE (${WALRUS_SHELL_TARGET} ${WALRUS_ROOT}/src/shell/Shell.cpp)
    SET_TARGET_PROPERTIES (${WALRUS_SHELL_TARGET} PROPERTIES OUTPUT_NAME ${WALRUS_TARGET})

    TARGET_LINK_LIBRARIES (${WALRUS_SHELL_TARGET} PRIVATE ${WALRUS_TARGET} ${WALRUS_LDFLAGS_SHELL})
    TARGET_INCLUDE_DIRECTORIES (${WALRUS_SHELL_TARGET} PRIVATE ${WALRUS_INCDIRS})
    TARGET_COMPILE_DEFINITIONS (${WALRUS_SHELL_TARGET} PRIVATE ${WALRUS_DEFINITIONS})
    TARGET_COMPILE_OPTIONS (${WALRUS_SHELL_TARGET} PRIVATE ${WALRUS_CXXFLAGS} ${WALRUS_CXXFLAGS_SHELL} ${CXXFLAGS_FROM_ENV} ${PROFILER_FLAGS})
ENDIF()
