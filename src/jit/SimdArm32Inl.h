...
static void simdEmitI64x2Abs(sljit_compiler* compiler, sljit_s32 vd, sljit_s32 vm)
{
    sljit_s32 tmpFReg = SLJIT_TMP_DEST_FREG;

    simdEmitOp(compiler, SimdOp::Type::vshrImm | SimdOp::lBit | (1 << 16), tmpFReg, 0, vm);
    simdEmitOp(compiler, SimdOp::Type::veor, vd, vm, tmpFReg);
    simdEmitOp(compiler, SimdOp::Type::vsub | SimdOp::I64, vd, vd, tmpFReg);
}
...
static void simdEmitDot(sljit_compiler* compiler, uint32_t type, sljit_s32 vd, sljit_s32 vn, sljit_s32 vm)
{
    sljit_s32 tmpFReg = SLJIT_TMP_DEST_FREG;
    uint32_t lowType = type - (0x1 << SimdOp::sizeOffset);

    simdEmitOp(compiler, SimdOp::Type::vmull | lowType, tmpFReg, vn, vm);
    simdEmitOp(compiler, SimdOp::Type::vpadd | type, vd, tmpFReg, tmpFReg | highRegister);
    simdEmitOp(compiler, SimdOp::Type::vmull | lowType, tmpFReg, vn | highRegister, vm | highRegister);
    simdEmitOp(compiler, SimdOp::Type::vpadd | type, vd | highRegister, tmpFReg, tmpFReg | highRegister);
}
...
static void emitUnarySIMD(sljit_compiler* compiler, Instruction* instr)
{
    ...
    case ByteCode::I8X16NegOpcode:
        ...
        break;
    case ByteCode::I8X16AbsOpcode:
        simdEmitOp(compiler, SimdOp::Type::vabs | SimdOp::S8, dst, 0, args[0].arg);
        break;
    case ByteCode::I8X16PopcntOpcode:
        simdEmitOp(compiler, SimdOp::Type::vcnt | SimdOp::S8, dst, 0, args[0].arg);
        break;
    case ByteCode::I16X8ExtendLowI8X16SOpcode:
    ...
    case ByteCode::I16X8NegOpcode:
        ...
        break;
    case ByteCode::I16X8AbsOpcode:
        simdEmitOp(compiler, SimdOp::Type::vabs | SimdOp::S16, dst, 0, args[0].arg);
        break;
    case ByteCode::I32X4ExtendLowI16X8SOpcode:
    ...
    case ByteCode::I32X4NegOpcode:
        ...
        break;
    case ByteCode::I32X4AbsOpcode:
        simdEmitOp(compiler, SimdOp::Type::vabs | SimdOp::S32, dst, 0, args[0].arg);
        break;
    case ByteCode::F32X4ConvertI32X4SOpcode:
    ...
    case ByteCode::I64X2NegOpcode:
        ...
        break;
    case ByteCode::I64X2AbsOpcode:
        simdEmitI64x2Abs(compiler, dst, args[0].arg);
        break;
    case ByteCode::I64X2ExtendLowI32X4SOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmovl | SimdOp::immS32, dst, 0, args[0].arg);
        break;
    case ByteCode::I64X2ExtendHighI32X4SOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmovl | SimdOp::immS32, dst, 0, args[0].arg | highRegister);
        break;
    case ByteCode::I64X2ExtendLowI32X4UOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmovl | SimdOp::immS32 | SimdOp::unsignedBit, dst, 0, args[0].arg);
        break;
    case ByteCode::I64X2ExtendHighI32X4UOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmovl | SimdOp::immS32 | SimdOp::unsignedBit, dst, 0, args[0].arg | highRegister);
        break;
    case ByteCode::V128NotOpcode:
...
static void emitBinarySIMD(sljit_compiler* compiler, Instruction* instr)
{
    ...
    if (!isCallback) {
        ...
        bool isSwizzle = (instr->opcode() == ByteCode::I8X16SwizzleOpcode || instr->opcode() == ByteCode::I8X16RelaxedSwizzleOpcode);
        args[2].set(operands + 2);
        dst = GET_TARGET_REG(args[2].arg, instr->requiredReg(isSwizzle ? 1 : 2));
    } else {
    ...
    case ByteCode::I8X16GeUOpcode:
        ...
        break;
    case ByteCode::I8X16MinSOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmin | SimdOp::I8, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I8X16MinUOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmin | SimdOp::I8 | SimdOp::unsignedBit, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I8X16MaxSOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmax | SimdOp::I8, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I8X16MaxUOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmax | SimdOp::I8 | SimdOp::unsignedBit, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I8X16AvgrUOpcode:
        simdEmitOp(compiler, SimdOp::Type::vrhadd | SimdOp::I8 | SimdOp::unsignedBit, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I16X8ExtmulLowI8X16SOpcode:
    ...
    case ByteCode::I16X8GeUOpcode:
        ...
        break;
    case ByteCode::I16X8MinSOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmin | SimdOp::I16, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I16X8MinUOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmin | SimdOp::I16 | SimdOp::unsignedBit, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I16X8MaxSOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmax | SimdOp::I16, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I16X8MaxUOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmax | SimdOp::I16 | SimdOp::unsignedBit, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I16X8AvgrUOpcode:
        simdEmitOp(compiler, SimdOp::Type::vrhadd | SimdOp::I16 | SimdOp::unsignedBit, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I8X16NarrowI16X8SOpcode:
    ...
    case ByteCode::I32X4ExtmulHighI16X8UOpcode:
        ...
        break;
    case ByteCode::I32X4DotI16X8SOpcode:
        simdEmitDot(compiler, SimdOp::I32, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I16X8Q15mulrSatSOpcode:
    case ByteCode::I16X8RelaxedQ15mulrSOpcode:
        ...
        break;
    case ByteCode::I16X8DotI8X16I7X16SOpcode:
        simdEmitDot(compiler, SimdOp::I16, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I32X4AddOpcode:
    ...
    case ByteCode::I32X4GeUOpcode:
        ...
        break;
    case ByteCode::I32X4MinSOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmin | SimdOp::I32, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I32X4MinUOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmin | SimdOp::I32 | SimdOp::unsignedBit, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I32X4MaxSOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmax | SimdOp::I32, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I32X4MaxUOpcode:
        simdEmitOp(compiler, SimdOp::Type::vmax | SimdOp::I32 | SimdOp::unsignedBit, dst, args[0].arg, args[1].arg);
        break;
    case ByteCode::I16X8NarrowI32X4SOpcode:
...
static void simdEmitDotAdd(sljit_compiler* compiler, sljit_s32 vd, sljit_s32 vn, sljit_s32 vm, sljit_s32 vo)
{
    sljit_s32 tmpFReg = SLJIT_TMP_DEST_FREG;

    simdEmitOp(compiler, SimdOp::Type::vmull | SimdOp::I8, tmpFReg, vn, vm);
    simdEmitOp(compiler, SimdOp::Type::vpadd | SimdOp::I16, tmpFReg, tmpFReg, tmpFReg | highRegister);
    simdEmitOp(compiler, SimdOp::Type::vpadal | (1 << 18), vd, 0, tmpFReg);

    simdEmitOp(compiler, SimdOp::Type::vmull | SimdOp::I8, tmpFReg, vn | highRegister, vm | highRegister);
    simdEmitOp(compiler, SimdOp::Type::vpadd | SimdOp::I16, tmpFReg, tmpFReg, tmpFReg | highRegister);
    simdEmitOp(compiler, SimdOp::Type::vpadal | (1 << 18), vd | highRegister, 0, tmpFReg);
}
...
static void emitTernarySIMD(sljit_compiler* compiler, Instruction* instr)
{
    ...
    case ByteCode::I32X4DotI8X16I7X16AddSOpcode:
        ...
        break;
    case ByteCode::F32X4RelaxedMaddOpcode:
        simdEmitF32x4Binary(compiler, SimdOp::Type::vmulf, SLJIT_TMP_DEST_FREG, args[0].arg, args[1].arg);
        simdEmitF32x4Binary(compiler, SimdOp::Type::vaddf, dst, args[2].arg, SLJIT_TMP_DEST_FREG);
        break;
    case ByteCode::F32X4RelaxedNmaddOpcode:
        simdEmitF32x4Binary(compiler, SimdOp::Type::vmulf, SLJIT_TMP_DEST_FREG, args[0].arg, args[1].arg);
        simdEmitF32x4Binary(compiler, SimdOp::Type::vsubf, dst, args[2].arg, SLJIT_TMP_DEST_FREG);
        break;
    case ByteCode::F64X2RelaxedMaddOpcode:
        simdEmitF64x2Binary(compiler, SimdOp::Type::vmulf | SimdOp::SF64, SLJIT_TMP_DEST_FREG, args[0].arg, args[1].arg);
        simdEmitF64x2Binary(compiler, SimdOp::Type::vaddf | SimdOp::SF64, dst, args[2].arg, SLJIT_TMP_DEST_FREG);
        break;
    case ByteCode::F64X2RelaxedNmaddOpcode:
        simdEmitF64x2Binary(compiler, SimdOp::Type::vmulf | SimdOp::SF64, SLJIT_TMP_DEST_FREG, args[0].arg, args[1].arg);
        simdEmitF64x2Binary(compiler, SimdOp::Type::vsubf | SimdOp::SF64, dst, args[2].arg, SLJIT_TMP_DEST_FREG);
        break;
    default:
        ASSERT_NOT_REACHED();
        break;
