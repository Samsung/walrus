...
static void emitAtomicRmwCmpxchg64(sljit_compiler* compiler, Instruction* instr)
{
    ...
    if (srcExpectedArgPair.arg1 != SLJIT_MEM1(kFrameReg)) {
        ...
        sljit_emit_op2(compiler, SLJIT_ADD, SLJIT_R1, 0, kFrameReg, 0, SLJIT_IMM, srcExpectedArgPair.arg1w - WORD_LOW_OFFSET);
    }
    ...
    if (srcExpectedArgPair.arg1 != SLJIT_MEM1(kFrameReg)) {
        ...
        sljit_emit_op1(compiler, SLJIT_MOV, dstArgPair.arg1, dstArgPair.arg1w, SLJIT_MEM1(kFrameReg), srcExpectedArgPair.arg1w - WORD_LOW_OFFSET);
        sljit_emit_op1(compiler, SLJIT_MOV, dstArgPair.arg2, dstArgPair.arg2w, SLJIT_MEM1(kFrameReg), srcExpectedArgPair.arg2w - WORD_LOW_OFFSET);
    }
}
...
static void emitAtomic(sljit_compiler* compiler, Instruction* instr)
{
...
#if (defined SLJIT_32BIT_ARCHITECTURE && SLJIT_32BIT_ARCHITECTURE)
        if (instr->opcode() != ByteCode::I64AtomicRmwCmpxchgOpcode) {
    ...
    if (!(operationSize & SLJIT_32) && operationSize != SLJIT_MOV32) {
        sljit_emit_op1(compiler, SLJIT_MOV, tmpReg, 0, srcExpectedPair.arg2, srcExpectedPair.arg2w);
    }
