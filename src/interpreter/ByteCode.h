...
class ByteCodeOffset2ValueMemIdx64 : public ByteCode {
public:
    ByteCodeOffset2ValueMemIdx64(uint32_t index, uint32_t alignment, Opcode opcode, ByteCodeStackOffset stackOffset1, ByteCodeStackOffset stackOffset2, uint64_t value)
        : ByteCode(opcode)
        , m_memIndex(index)
        , m_alignment(alignment)
        , m_stackOffset1(stackOffset1)
...
class ByteCodeOffset4ValueMemIdx64 : public ByteCode {
public:
    ByteCodeOffset4ValueMemIdx64(uint32_t index, uint32_t alignment, Opcode opcode, ByteCodeStackOffset src0Offset, ByteCodeStackOffset src1Offset, ByteCodeStackOffset src2Offset, ByteCodeStackOffset dstOffset, uint64_t value)
        : ByteCode(opcode)
        , m_memIndex(index)
        , m_alignment(alignment)
        , m_stackOffset1(src0Offset)
...
class MemoryLoadMemIdxM64 : public ByteCodeOffset2ValueMemIdx64 {
public:
    MemoryLoadMemIdxM64(uint32_t index, uint32_t alignment, Opcode code, uint64_t offset, ByteCodeStackOffset srcOffset, ByteCodeStackOffset dstOffset)
        : ByteCodeOffset2ValueMemIdx64(index, alignment, code, srcOffset, dstOffset, offset)
    {
    }
...
class MemoryLoadFloatMemIdxM64 : public ByteCodeOffset2ValueMemIdx64 {
public:
    MemoryLoadFloatMemIdxM64(uint32_t index, uint32_t alignment, Opcode code, uint64_t offset, ByteCodeStackOffset srcOffset, ByteCodeStackOffset dstOffset)
        : ByteCodeOffset2ValueMemIdx64(index, alignment, code, dstOffset, srcOffset, offset)
    {
    }
...
class MemoryStoreMemIdx32M64 : public ByteCodeOffset2ValueMemIdx64 {
public:
    MemoryStoreMemIdx32M64(uint32_t memIndex, uint32_t alignment, Opcode opcode, uint64_t offset, ByteCodeStackOffset src0, ByteCodeStackOffset src1)
        : ByteCodeOffset2ValueMemIdx64(memIndex, alignment, opcode, src0, src1, offset)
    {
    }
...
class MemoryStoreMemIdx64M64 : public ByteCodeOffset2ValueMemIdx64 {
public:
    MemoryStoreMemIdx64M64(uint32_t memIndex, uint32_t alignment, Opcode opcode, uint64_t offset, ByteCodeStackOffset src0, ByteCodeStackOffset src1)
        : ByteCodeOffset2ValueMemIdx64(memIndex, alignment, opcode, src1, src0, offset)
    {
    }
...
public:
    V128Load32ZeroMemIdx(uint32_t index, uint32_t alignment, uint32_t offset, ByteCodeStackOffset srcOffset, ByteCodeStackOffset dstOffset)
        : MemoryLoad(Opcode::V128Load32ZeroMemIdxOpcode, offset, srcOffset, dstOffset)
        , m_memIndex(index)
        , m_alignment(alignment)
    {
    }
...
class V128Load32ZeroMemIdxM64 : public MemoryLoadM64 {
public:
    V128Load32ZeroMemIdxM64(uint32_t index, uint32_t alignment, uint64_t offset, ByteCodeStackOffset srcOffset, ByteCodeStackOffset dstOffset)
        : MemoryLoadM64(Opcode::V128Load32ZeroMemIdxM64Opcode, offset, srcOffset, dstOffset)
        , m_memIndex(index)
        , m_alignment(alignment)
    {
    }
...
public:
    V128Load64ZeroMemIdx(uint32_t index, uint32_t alignment, uint32_t offset, ByteCodeStackOffset srcOffset, ByteCodeStackOffset dstOffset)
        : MemoryLoad(Opcode::V128Load64ZeroMemIdxOpcode, offset, srcOffset, dstOffset)
        , m_memIndex(index)
        , m_alignment(alignment)
    {
    }
...
class V128Load64ZeroMemIdxM64 : public MemoryLoadM64 {
public:
    V128Load64ZeroMemIdxM64(uint32_t index, uint32_t alignment, uint64_t offset, ByteCodeStackOffset srcOffset, ByteCodeStackOffset dstOffset)
        : MemoryLoadM64(Opcode::V128Load64ZeroMemIdxM64Opcode, offset, srcOffset, dstOffset)
        , m_memIndex(index)
        , m_alignment(alignment)
    {
    }
