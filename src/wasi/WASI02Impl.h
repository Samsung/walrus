...
public:
    enum Type {
        ...
        socketsInstanceNetwork02,
        socketsUdpCreateSocket02,
        socketsUdpStartBind02,
        socketsUdpFinishBind02,
        socketsUdpStream02,
        socketsUdpLocalAddress02,
        ...
        socketsTcpStartBind02,
        socketsTcpFinishBind02,
        socketsTcpStartConnect02,
        socketsTcpFinishConnect02,
        socketsTcpStartListen02,
        socketsTcpFinishListen02,
        socketsTcpAccept02,
        socketsTcpLocalAddress02,
        socketsTcpRemoteAddress02,
        socketsTcpIsListening02,
        socketsTcpSetListenBacklogSize02,
        socketsTcpKeepAliveEnabled02,
        socketsTcpSetKeepAliveEnabled02,
        socketsTcpKeepAliveIdleTime02,
        socketsTcpSetKeepAliveIdleTime02,
        socketsTcpKeepAliveInterval02,
        socketsTcpSetKeepAliveInterval02,
        socketsTcpKeepAliveCount02,
        ...
        socketsOutgoingDatagramStreamSubscribe02,
