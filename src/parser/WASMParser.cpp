...
#undef GENERATE_RMW_CMPXCHG_CODE_CASE
    ...
    virtual void OnArrayFillExpr(Index type_index) override
    {
        ...
        bool isNullable = Walrus::Value::isNullableRefType(peekVMStackValueType());
        auto src0 = popVMStack();
        pushByteCode(Walrus::ArrayFill((uint32_t)type_index, typeInfo->field().type(), isNullable, src0, src1, src2, src3), WASMOpcode::ArrayFillOpcode);
    }
    ...
    virtual void OnArrayCopyExpr(Index dst_type_index, Index src_type_index) override
    {
        ...
        uint8_t log2Size = Walrus::GCArray::getLog2Size(dstTypeInfo->field().type());
        ASSERT(peekVMStackValueType() == Walrus::Value::Type::I32);
        ...
        auto src0 = popVMStack();
        pushByteCode(Walrus::ArrayCopy((uint32_t)dst_type_index, (uint32_t)src_type_index, log2Size, dstIsNullable, srcIsNullable, src0, src1, src2, src3, src4), WASMOpcode::ArrayCopyOpcode);
    }
