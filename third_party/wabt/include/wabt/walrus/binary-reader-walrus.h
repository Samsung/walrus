...
public:
    ...
    virtual void OnImportMemory(Index importIndex, std::string moduleName, std::string fieldName, Index memoryIndex, size_t initialSize, size_t maximumSize, bool is_shared) = 0;
    ...
    virtual void OnMemory(Index index, uint64_t initialSize, uint64_t maximumSize, bool is_shared) = 0;
